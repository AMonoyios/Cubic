    ...
    public bool Front
    {
        get
        {
            return  world.CheckForVoxel(transform.position.x, transform.position.y, transform.position.z + playerWidth) ||
                    world.CheckForVoxel(transform.position.x, transform.position.y + (playerHeight / 2.0f), transform.position.z + playerWidth);
        }
    }
    ...
    public bool Right
    {
        get
        {
            return  world.CheckForVoxel(transform.position.x + playerWidth, transform.position.y, transform.position.z) ||
                    world.CheckForVoxel(transform.position.x + playerWidth, transform.position.y + (playerHeight / 2.0f), transform.position.z);
        }
    }
